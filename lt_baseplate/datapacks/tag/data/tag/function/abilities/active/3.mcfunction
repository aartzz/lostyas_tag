...
execute unless score @s effect.invisibility matches 1.. if score @s ab.use matches 1.. run item replace entity @s armor.feet with diamond_boots[minecraft:enchantments={binding_curse:1}, minecraft:tooltip_display={hidden_components:["minecraft:enchantments"]}, minecraft:enchantment_glint_override=true, minecraft:custom_data={game:7}, minecraft:custom_name={"text":""}]
execute unless score @s effect.invisibility matches 1.. if score @s ab.use matches 1.. run item replace entity @s armor.legs with diamond_leggings[minecraft:enchantments={binding_curse:1}, minecraft:tooltip_display={hidden_components:["minecraft:enchantments"]}, minecraft:enchantment_glint_override=true, minecraft:custom_data={game:7}, minecraft:custom_name={"text":""}]
execute unless score @s effect.invisibility matches 1.. if score @s ab.use matches 1.. run item replace entity @s armor.chest with diamond_chestplate[minecraft:enchantments={binding_curse:1}, minecraft:tooltip_display={hidden_components:["minecraft:enchantments"]}, minecraft:enchantment_glint_override=true, minecraft:custom_data={game:7}, minecraft:custom_name={"text":""}]
