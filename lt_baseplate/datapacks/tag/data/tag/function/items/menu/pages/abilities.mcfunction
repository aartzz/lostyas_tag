...
execute if score @s menu.selecting matches 1 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 1, cd: 30, cd_format: sec, cd_count: many, use: 0, use_format: ticks, use_count: many}
execute if score @s menu.selecting matches 2 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 2, cd: 40, cd_format: sec, cd_count: many, use: 3, use_format: ticks, use_count: two}
...
execute if score @s menu.selecting matches 4 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 4, cd: 36, cd_format: sec, cd_count: many, use: 5, use_format: sec, use_count: many}
execute if score @s menu.selecting matches 5 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 5, cd: 45, cd_format: sec, cd_count: many, use: 5, use_format: sec, use_count: many}
